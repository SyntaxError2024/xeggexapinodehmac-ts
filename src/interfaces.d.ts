...
declare namespace Xeggex {

	type floatAsString = string

	type Status = "active" | "filled" | "cancelled"
	type Side = "buy" | "sell"
	...
	interface Order {
		...
		"market": {
			"id": string
			"symbol": string // "XLM/USDT"
		},
		"side": Side
		"type": Type
		"price": floatAsString
		"quantity": floatAsString
		"executedQuantity": floatAsString
		"remainQuantity": floatAsString
		"remainTotal": floatAsString
		"remainTotalWithFee": floatAsString
		"lastTradeAt": number
		"status": Status
		"isActive": boolean
		"createdAt": EpochTimeStamp,
